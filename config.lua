...
Config.Locations = {
    ["checking"] = {
	[1] = vector3(306.76, -595.03, 43.28),
	[2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    [3] = vector3(312.29, -592.77, 43.28),
    },	
    ["duty"] = {
        [1] = vector3(306.94, -597.86, 43.28), -- Pillbox
        [2] = vector3(-256.25, 6330.39, 32.43), -- Paleto
    },
    ["vehicle"] = {
        [1] = vector4(293.43, -575.4, 43.19, 48.82), -- Pillbox
    ...
    ["armory"] = {
        [1] = vector3(304.70004, -600.1873, 43.284053), -- Pillbox
        [2] = vector3(-245.13, 6315.71, 32.82), -- Paleto
    },
    ["roof"] = {
        [1] = vector3(338.5, -583.85, 74.16),  -- On Roof to the Lobby Left Elevator
    },
    ["main"] = {
        [1] = vector3(332.51, -595.74, 43.28),
    },
	["stash"] = {
        [1] = vector3(298.77, -598.32, 43.28),
    },	
    ["beds"] = {
		[1] = {coords = vector4(319.2, -581.12, 44.2, 330.29), taken = false, model = 1631638868},
        [2] = {coords = vector4(324.16, -583.21, 44.2, 327.1), taken = false, model = 1631638868},
        [3] = {coords = vector4(314.26, -578.95, 44.2, 24.98), taken = false, model = 1631638868},
        [4] = {coords = vector4(309.5, -577.17, 44.2, 343.65), taken = false, model = 1631638868},
        [5] = {coords = vector4(308.05, -581.57, 44.2, 130.22), taken = false, model = 1631638868}, 
        [6] = {coords = vector4(310.71, -583.09, 44.2, 180.42), taken = false, model = 1631638868}, 
        [7] = {coords = vector4(310.71, -583.09, 44.2, 180.42), taken = false, model = 1631638868}, 
        [8] = {coords = vector4(310.71, -583.09, 44.2, 180.42), taken = false, model = 1631638868},
        [9] = {coords = vector4(310.71, -583.09, 44.2, 180.42), taken = false, model = 1631638868},
    ...
    ["stations"] = {
        [1] = {label = "CHU Hospital", coords = vector4(304.27, -600.33, 43.28, 272.249)},
        [2] = {label = "CHU Hospital", coords = vector4(-253.74, 6331.91, 32.43, 288.31)}
    }
}
